...
class DocumentsFolder:
    ...
    def prm_ranking(self, K1: float = 1.2, K2: float = 500, B: float = 0.85, top_k_ratio: float = 0.1, size: float = 150):
        ...
        for doc_id in document_weighting:
            ...
            combined_weighting[doc_id] = 0.5 * document_weighting[doc_id] + 0.5 * self.bm25_ranking_result[doc_id]
